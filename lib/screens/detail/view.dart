...
class DrinkDetailScreen extends GetView<DrinkDetailController> {
  ...
  Widget build(BuildContext context) {
    controller.fetchProduct(id);
    return Scaffold(
      body: GetBuilder<DrinkDetailController>(
          id: "detail",
          builder: (context) {
              ...
              children: [
                ...
                Container(
                  color: Colors.black.withValues(
                      alpha: .3), // Dark overlay for better contrast
                ),
                        ...
                        Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                border:
                                    Border.all(color: hexToColor("#C58346"))),
                            child: Padding(
                              padding: const EdgeInsets.all(16.0),
                              child: Column(
                                children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ...(controller.detail!.instructions)
                                                .map((e) => instructionItem(
                                                    e.first, e.second))
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildButton("LEARN MORE", hexToColor("#C58346"),
                                  Colors.white)
                            ],
                          ),
                        ),
